...
let check=prompt("Please Enter Your Address");
	alert("Your Order is on its Way to " + check +".");
})
...
const comboMeal=document.getElementById("comboMeal");
const desserts=document.getElementById("desserts");
const shakes=document.getElementById("shakes");
const beveragesGrid=document.getElementById("grid");
const breakfastGrid=document.getElementById("grids");
...
beverages.addEventListener("click", function(){
	beveragesGrid.style.display="block";
	breakfastGrid.style.display="none";
	burgerGrid.style.display="none";
	cakesGrid.style.display="none";
	sandwichGrid.style.display="none";
	coffeeGrid.style.display="none";
	comboGrid.style.display="none";
	dessertGrid.style.display="none";
	shakesGrid.style.display="none";
})
// breakfastgrid
breakfast.addEventListener("click", function(){
	breakfastGrid.style.display="block";
	beveragesGrid.style.display="none";
	burgerGrid.style.display="none";
	cakesGrid.style.display="none";
	sandwichGrid.style.display="none";
	coffeeGrid.style.display="none";
...
burgers.addEventListener("click", function(){
	beveragesGrid.style.display="none";
	breakfastGrid.style.display="none";
	burgerGrid.style.display="block";
	cakesGrid.style.display="none";
	sandwichGrid.style.display="none";
	coffeeGrid.style.display="none";
	comboGrid.style.display="none";
...
sandwiches.addEventListener("click", function(){
	...
	burgerGrid.style.display="none";
	cakesGrid.style.display="none";
	sandwichGrid.style.display="block";
	coffeeGrid.style.display="none";
	comboGrid.style.display="none";
	dessertGrid.style.display="none";
	shakesGrid.style.display="none";
...
coffee.addEventListener("click", function(){
	...
	cakesGrid.style.display="none";
	sandwichGrid.style.display="none";
	coffeeGrid.style.display="block";
	comboGrid.style.display="none";
	dessertGrid.style.display="none";
	shakesGrid.style.display="none";
})
// combomealgrid
comboMeal.addEventListener("click", function(){
	beveragesGrid.style.display="none";
	breakfastGrid.style.display="none";
	burgerGrid.style.display="none";
	cakesGrid.style.display="none";
...
desserts.addEventListener("click", function(){
	...
	coffeeGrid.style.display="none";
	comboGrid.style.display="none";
	dessertGrid.style.display="block";
	shakesGrid.style.display="none";
})
// shakesgrid
shakes.addEventListener("click", function(){
	...
	comboGrid.style.display="none";
	dessertGrid.style.display="none";
	shakesGrid.style.display="block";
})
